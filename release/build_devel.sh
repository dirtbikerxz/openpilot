...
add_subtree() {
  ...
  if [ -d "$2" ]; then
    if git subtree pull --prefix "$2" https://github.com/dirtbikerxz/"$1".git "$3" --squash -m "Merge $2 subtree"; then
      ...
      git subtree add --prefix "$2" https://github.com/dirtbikerxz/"$1".git "$3" --squash
    fi
  else
    git subtree add --prefix "$2" https://github.com/dirtbikerxz/"$1".git "$3" --squash
  fi
...
export GIT_COMMITTER_NAME="Rohit Gondi"
export GIT_COMMITTER_EMAIL="dirtbikerxz@gmail.com"
export GIT_AUTHOR_NAME="Rohit Gondi"
export GIT_AUTHOR_EMAIL="dirtbikerxz@gmail.com"
...
if [ ! -d "$TARGET_DIR" ]; then
    ...
    cd $TARGET_DIR
    git init
    git remote add origin git@github.com:dirtbikerxz/openpilot.git
fi
